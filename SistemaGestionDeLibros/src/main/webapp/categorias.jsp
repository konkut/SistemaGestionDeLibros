        ...
        <p><a href="CategoriaController?op=nuevo">Nuevo</a>
            <table border="2" class="table-dark">
                ...
                <tr>
                    ...
                    <td class="text-white"><%=item.getCategoria()%></td>
                    <td class="text-white"><a href="CategoriaController?op=editar&id=<%= item.getId()%>">Editar</a></td>
                    <td class="text-white"><a href="CategoriaController?op=eliminar&id=<%= item.getId()%>">Eliminar</a></td>
